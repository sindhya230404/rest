...
export const Route = createFileRoute("/reception/_app/billing/payments")({
...
function PaymentsPage() {
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV("reception_payments", exportRows);
      ...
      <Card className="p-4">
        <div className="mb-4 flex flex-wrap items-center gap-2">
          <div className="relative min-w-[220px] flex-1">
            ...
            <Input
              placeholder="Search transaction ID, invoice or customer…"
              className="pl-9"
              value={searchQuery}
                ...
                filtered.map((p) => {
                  ...
                  return (
                    <TableRow key={p.id} className="hover:bg-muted/40">
                      ...
                      <TableCell><span className="rounded-md bg-muted px-2 py-0.5 text-xs font-medium">{p.method}</span></TableCell>
