  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 z-40 glass border-b px-4 py-2.5 flex items-center justify-between">
        ...
        <Link to="/qr" className="inline-flex items-center gap-1 text-xs font-semibold bg-primary/10 text-primary px-3 py-1 rounded-full border border-primary/20">
      ...
      <header className="hidden md:flex sticky top-0 z-40 items-center justify-between px-8 py-4 glass border-b">
        ...
        <div className="flex items-center gap-3">
          <Link to="/qr" className="inline-flex items-center gap-1.5 text-xs font-semibold bg-primary/10 text-primary px-3.5 py-1.5 rounded-full border border-primary/20 hover:bg-primary/20 transition">
