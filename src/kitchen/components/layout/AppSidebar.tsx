  ...
  return (
    <Sidebar collapsible="icon" className="border-r">
      <SidebarHeader className="border-b px-4 py-4">
        <Link to="/kitchen/orders/live" className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <div className="truncate text-[10px] uppercase tracking-wider text-muted-foreground">Kitchen Dashboard</div>
            </div>
          )}
        </Link>
      </SidebarHeader>
